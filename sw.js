const CACHE = 'guitar-practice-v75';
const SAMPLE_CACHE = 'guitar-samples-v1';
const ASSETS = ['./', './index.html', './styles.css', './override.css', './visual.css', './visual.css?v=2', './vendor/vexflow.js', './vendor/vexflow.js?v=5.0.0', './app.js', './app.js?v=73', './manifest.webmanifest', './icons/icon.svg'];
