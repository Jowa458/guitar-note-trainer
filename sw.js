const CACHE = 'guitar-practice-v85';
const SAMPLE_CACHE = 'guitar-samples-v1';
const ASSETS = ['./', './index.html', './styles.css', './override.css', './visual.css', './visual.css?v=8', './vendor/vexflow.js', './vendor/vexflow.js?v=5.0.0', './app.js', './app.js?v=80', './chords.js?v=3', './chords.css?v=2', './manifest.webmanifest', './icons/icon.svg'];
