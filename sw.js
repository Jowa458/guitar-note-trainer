const CACHE = 'guitar-practice-v88';
const SAMPLE_CACHE = 'guitar-samples-v1';
const ASSETS = ['./', './index.html', './styles.css', './override.css', './visual.css', './visual.css?v=8', './vendor/vexflow.js', './vendor/vexflow.js?v=5.0.0', './app.js', './app.js?v=82', './chords.js?v=10', './chords.css?v=2', './manifest.webmanifest', './icons/icon.svg'];
